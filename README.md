...
In one terminal window, start Surfpool in your project directory: surfpool start This launches a local Surfnet validator and deploys your program.

In a new terminal window (in the same directory), run the Anchor tests against it: anchor test --skip-local-validator This will execute the tests in tests/anchor-escrow-q4-25.ts, covering make/refund and make/take scenarios.
